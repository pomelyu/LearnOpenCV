...
// Modified From https://github.com/opencv/opencv/wiki/DisplayManyImages
/*Function///////////////////////////////////////////////////////////////
...
void ShowManyImages(string title, vector<Mat> images) {
    ...
    for (i = 0, m = 20, n = 20; i < nArgs; i++, m += (20 + size)) {
        ...
        if (images[i].channels() == 1) {
            img = Mat(images[i].size(), CV_8UC3);
            cvtColor(images[i], img, CV_GRAY2BGR);
        } else {
            img = images[i];
        }
